            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <div class="row">
                            <div class="col-lg-12">
                                <a class="btn btn-success" href="{{ route('admin.department.create') }}">Add Department</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table id="department_table" class="table table-striped table-bordered dom-jQuery-events">
                            ...
                            <tbody>
                                ...
                                <tr data-entry-id="{{ $department->id }}">
                                    ...
                                    <td>@if($department->status=='1') Active @else Deactivated @endif</td>
                                    <td>
                                        <a class="btn btn-xs btn-secondary" href="{{ route('admin.department.edit', $department->id) }}"><span class="material-icons">create</span></a>
