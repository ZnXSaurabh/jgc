                            ...
                            <form id="candidate-update" class="steps-validation wizard-circle" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ $candidate->profile->dob }}" type="text" placeholder="Choose Date Of Birth" class="form-control required" id="datepicker" name="dob" >
                                ...
                                <fieldset>
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <a download href="{{ \Illuminate\Support\Facades\Storage::url($candidate->profile->resume) }}"><span class="material-icons" style="font-size:5.71em;padding-top:20px;">picture_as_pdf</span></a>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <img class="img-fluid img-thumbnail" src="{{ \Illuminate\Support\Facades\Storage::url($candidate->profile->profile_pic) }}" alt="">
                                        </div>
                                        <div class="col-md-12">
