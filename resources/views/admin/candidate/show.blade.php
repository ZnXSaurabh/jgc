            ...
            <div class="col-12 col-sm-7">
                <div class="media mb-2">
                    ...
                    <div class="media-body pt-25">
                        ...
                        <span class="users-view-name">{{ $profile->user->name ?? '' }} </span><span class="text-muted font-medium-1">#</span><span class="users-view-username text-muted font-medium-1"><em>{{ $profile->user->email ?? '' }}</em></span>
                        </h4>
                        <span>ID:</span>
                        <span class="users-view-id">{{ $profile->user->id ?? '' }}</span>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-12 col-md-4">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Verified:</td>
                                        <td class="users-view-verified">@if($profile->user->status == 1) Yes @else No @endif</td>
                                    </tr>
                                    <tr>
                                        <td>Role:</td>
                                        <td class="users-view-role">{{ $profile->user->roles[0]->title }}</td>
                                    </tr>
                                    <tr>
                                        <td>Status:</td>
                                        <td><span class="badge @if($profile->user->status == 1) badge-success @else badge-danger @endif users-view-status">@if($profile->user->status == 1) Active @else Inactive @endif</span></td>
                                    </tr>
                                    <tr>
                                        <td>Resume:</td>
                                        <td><a class="btn btn-xs btn-primary" href="{{ \Illuminate\Support\Facades\Storage::url($profile->resume) }}" download>Download</a></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="col-12">
                        <table class="table table-borderless">
                            <tbody>
                                <tr>
                                    <td>Username:</td>
                                    <td class="users-view-username">{{ $profile->user->email }}</td>
                                </tr>
                                <tr>
                                    <td>Name:</td>
                                    <td class="users-view-name">{{ $profile->user->name }}</td>
                                </tr>
                                <tr>
                                    <td>Phone:</td>
                                ...
                                <tr>
                                    <td>E-mail:</td>
                                    <td class="users-view-email">{{ $profile->user->email }}</td>
                                </tr>
                            </tbody>
                        </table>
