            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <div class="row">
                            <div class="col-lg-12">
                                <a class="btn btn-danger" href="{{ route('admin.hr.index') }}"><span class="material-icons">keyboard_backspace</span> Back</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard dataTables_wrapper dt-bootstrap">
                        <form action="{{route('admin.hr.update',$hr->user->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row ">
                                <div class="form-group col-6 {{ $errors->has('name') ? 'has-error' : '' }}">
                                    <label for="name">Name *</label>
                                    <input type="text" name="name" value="{{ $hr->user->name }}" class="form-control">
                                    @if($errors->has('name'))
                                ...
                                <div class="form-group col-6 {{ $errors->has('email') ? 'has-error' : '' }}">
                                    ...
                                    <input type="email" value="{{ $hr->user->email }}" name="email" class="form-control">
                                    @if($errors->has('email'))
                                ...
                                <!-- <div class="form-group col-6 {{ $errors->has('phone') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" value="{{ $hr->user->phone }}" name="phone" id="phone" class="form-control">
                                    @if($errors->has('phone'))
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('employee_no') ? 'has-error' : '' }}">
									...
									<input type="text" value="{{$hr->emp_no}}" name="employee_no" class="form-control">
									@if($errors->has('employee_no'))
									<p class="text-danger">{{ $errors->first('employee_no') }}</p>
									@endif
								</div>
                                <div class="form-group col-6 {{ $errors->has('status') ? 'has-error' : '' }}{{ $errors->has('status') ? 'has-error' : '' }}">
                                    <label for="status">Choose Status</label>
                                    <select name="status" id="status" class="form-control select2" required>
                                        @if($hr->user->status == '1')
                                        <option value="1" selected>Activate</option>
                                        <option value="0">Deactivate</option>
                                        @elseif($hr->user->status == '0')
                                ...
                                <!-- <div class="form-group col-6 {{ $errors->has('pincode') ? 'has-error' : '' }}">
                                    <label for="pincode">Zip/Postal *</label>
                                    <input type="text" value="{{ $hr->zip_code }}" name="pincode" class="form-control">
                                ...
                                <div class="form-group col-6 {{ $errors->has('address') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" value="{{ $hr->address }}" name="address" class="form-control">
                                ...
                                <div class="form-group col-6 {{ $errors->has('city') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" value="{{ $hr->city }}" name="city" class="form-control">
                                    @if($errors->has('city'))
                                ...
                                <div class="form-group col-6 {{ $errors->has('state') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" value="{{$hr->state}}" name="state" class="form-control">
                                    @if($errors->has('state'))
                                ...
                                <div class="form-group col-6 {{ $errors->has('country') ? 'has-error' : '' }}">
                                    ...
                                    <select name="country" id="country" class="form-control select2">
                                        ...
                                        <option value="{{$country->name}}" {{ old('country', $hr->country == $country->name) ? 'selected' : '' }}>{{$country->name}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-6 {{ $errors->has('dob') ? 'has-error' : '' }}">
                                    ...
                                    <input type="date" name="dob" value="{{$hr->dob}}" class="form-control" max="{{ date('Y-m-d', strtotime('-18 years')) }}"  min="{{ date('Y-m-d', strtotime('-70 years')) }}">
                                    @if($errors->has('dob'))
                                ...
                                <div class="form-group col-12 {{ $errors->has('about') ? 'has-error' : '' }}">
                                    ...
                                    <textarea name="about" class="form-control">{{$hr->about}}</textarea>
                                    @if($errors->has('about'))
